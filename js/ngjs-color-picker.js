    ...
    .directive('ngjsColorPicker', function() {
        ...
        return {
            ...
            link: function (scope) { // element, attr
                ...
                // step (default 1): If you pass in 100 for percent it will
                // make your color pure white.
                //
                // If you pass in 0 for percent, nothing will happen.
                // If you pass in 1 for percent it will add 3 shades to all
                ...
                if (scope.gradient && !scope.customColors && !scope.options.randomColors){
                    ...
                    if (isOkHex){
                        ...
                        while (count !== 0){
                            scope.colors.push(_shadeColor(scope.colors.length === 0 ?
                ...
                scope.columnRound =
                    (scope.options.columns && scope.options.roundCorners && isOkColumn);

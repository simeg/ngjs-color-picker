  ...
  describe("with custom option", function() {
    ...
    describe("(selectedColor)", function() {
      ...
      beforeEach(function() {
        ...
        element = $compile('<ngjs-color-picker selected-color="selectedColor"></ngjs-color-picker>')($scope);
        $rootScope.$digest();
        content = element.contents();
      });
    ...
    describe("(gradient colors)", function() {
      ...
      beforeEach(function() {
        ...
        element = $compile('<ngjs-color-picker gradient="gradient"></ngjs-color-picker>')($scope);
        $rootScope.$digest();
        content = element.contents();
      });
